Gaming Realm Calculator
=======================

A Task I had to do for gaming realm. It is a text based calculator. Test Driven Development and Dependeny injection is used
...
The solution must read the input from files.
